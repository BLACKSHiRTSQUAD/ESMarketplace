...
try:
    ...
    esq2_34.save()
    esq2_35 = ESQuestion(prev_question_id=esq2_33, prev_choice_text="4?")
    esq2_35.save()
    esq2_36 = ESQuestion(prev_question_id=esq2_33, prev_choice_text="Ok. Then 5.")
    esq2_36.save()
    esq2_37 = ESQuestion(prev_question_id=esq2_31, prev_choice_text="3.")
    esq2_37.save()
    esq2_38 = ESQuestion(prev_question_id=esq2_31, prev_choice_text="2.")
    esq2_38.save()
    esq2_39 = ESQuestion(prev_question_id=esq2_31, prev_choice_text="1.")
    esq2_39.save()
    esq2_40 = ESQuestion(prev_question_id=esq2_31, prev_choice_text="BOOM!!!")
    esq2_40.save()
